...
const Projects = () => {
  const projects = [
    {
      id: 1,
      title: 'Universal Business Automation',
      description: 'A powerful AI-driven business automation platform that streamlines workflows, document processing, file conversion, analytics, authentication, and enterprise operations in one unified ecosystem.',
      category: 'AI Automation',
      image: '/images/UiverslBIzAutomate/UBA profile.png',
      technologies: ['React', 'Node.js', 'MongoDB', 'AI Automation']
    },
    {
      id: 2,
                ...
                <Card className="h-full overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex space-x-3">
                      {project.title === 'Universal Business Automation' ? (
                        <motion.div
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          <Link
                            to="/projects/universal-business-automation"
